...
public class ProvinceAdapter extends BaseAdapter {
    ...
    private int provinceIndex = Constant.INDEX_INVALID;;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        boolean checked = provinceIndex != Constant.INDEX_INVALID && mProList.get(provinceIndex).getName().equals(item.getName());
