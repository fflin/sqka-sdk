package com.hengxin.pickcity.adapter;
...
import com.hengxin.pickcity.Constant;
import com.hengxin.pickcity.R;
...
public class AreaAdapter extends BaseAdapter {
    ...
    private int districtIndex = Constant.INDEX_INVALID;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        boolean checked = districtIndex != Constant.INDEX_INVALID && mDistrictList.get(districtIndex).getName().equals(item.getName());
