...
public class ViewUtil {
    ...
    public static int dp2px(float dp) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, ContextProvider.get().getContext().getResources().getDisplayMetrics());
    }


    public static float sp2px(float sp) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, sp, ContextProvider.get().getContext().getResources().getDisplayMetrics());
    }
...
//     * @param defStyleRes
//     */
//    public static void applyStyle(View v, AttributeSet attrs.xml, int defStyleAttr, int defStyleRes){
//        TypedArray a = v.getContext().obtainStyledAttributes(attrs.xml, R.styleable.View, defStyleAttr, defStyleRes);
//
//        int leftPadding = -1;
//        int topPadding = -1;
//        int rightPadding = -1;
...
//            applyStyle((TextView)v, attrs.xml, defStyleAttr, defStyleRes);
//    }
//
//    public static void applyFont(TextView v, AttributeSet attrs.xml, int defStyleAttr, int defStyleRes){
//        TypedArray a = v.getContext().obtainStyledAttributes(attrs.xml, new int[]{R.attr.tv_fontFamily}, defStyleAttr, defStyleRes);
...
//     * @param defStyleRes
//     */
//    private static void applyStyle(TextView v, AttributeSet attrs.xml, int defStyleAttr, int defStyleRes){
//        String fontFamily = null;
//        int typefaceIndex = -1;
//        int styleIndex = -1;
//        int shadowColor = 0;
...
//         */
//        TypedArray a = v.getContext().obtainStyledAttributes(attrs.xml, R.styleable.TextViewAppearance, defStyleAttr, defStyleRes);
...
//        }
//
//        a = v.getContext().obtainStyledAttributes(attrs.xml, R.styleable.TextView, defStyleAttr, defStyleRes);
//
...
//            applyStyle((AutoCompleteTextView)v, attrs.xml, defStyleAttr, defStyleRes);
//    }
//
//    /**
...
//     * @param defStyleRes
//     */
//    private static void applyStyle(AutoCompleteTextView v,  AttributeSet attrs.xml, int defStyleAttr, int defStyleRes){
//        TypedArray a = v.getContext().obtainStyledAttributes(attrs.xml, R.styleable.AutoCompleteTextView, defStyleAttr, defStyleRes);
//
//        int n = a.getIndexCount();
//        for (int i = 0; i < n; i++) {
//            int attr = a.getIndex(i);
