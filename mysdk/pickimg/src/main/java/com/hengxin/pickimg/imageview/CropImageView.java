package com.hengxin.pickimg.imageview;
...
public class CropImageView extends MultiTouchZoomableImageView {
    ...
    public boolean saveCroppedImage(String path, int maxLength) {
        Bitmap cropped = getCroppedBitmap();
        return AttachmentStore.saveBitmap(cropped, path, cropped != mBitmap, maxLength);
    }
